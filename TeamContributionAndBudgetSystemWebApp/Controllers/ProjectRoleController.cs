    ...
    public class ProjectRoleController : BaseController
    {
        ...
        public ActionResult Edit(int? id)
        {
            ...
            try
            {
                ...
                if (projectRoleModel == null) return RedirectToIndexProjectRoleNotFound(projectRoleId);
        ...
        private ActionResult RedirectToIndexProjectRoleNotFound(int projectRoleId)
        {
